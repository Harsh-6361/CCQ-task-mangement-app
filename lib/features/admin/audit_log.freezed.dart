...
mixin _$AuditLog {
 ...
 String get id; String get actorId; String get action;// e.g., 'TASK_DELETED', 'LEAD_CREATED'
 String get targetId; DateTime get timestamp; Map<String, dynamic>? get metadata;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,actorId,action,targetId,timestamp,const DeepCollectionEquality().hash(metadata));

@override
String toString() {
  return 'AuditLog(id: $id, actorId: $actorId, action: $action, targetId: $targetId, timestamp: $timestamp, metadata: $metadata)';
}
...
@useResult
$Res call({
 String id, String actorId, String action, String targetId, DateTime timestamp, Map<String, dynamic>? metadata
});
...
/// Create a copy of AuditLog
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? actorId = null,Object? action = null,Object? targetId = null,Object? timestamp = null,Object? metadata = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String actorId,  String action,  String targetId,  DateTime timestamp,  Map<String, dynamic>? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuditLog() when $default != null:
return $default(_that.id,_that.actorId,_that.action,_that.targetId,_that.timestamp,_that.metadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String actorId,  String action,  String targetId,  DateTime timestamp,  Map<String, dynamic>? metadata)  $default,) {final _that = this;
switch (_that) {
case _AuditLog():
return $default(_that.id,_that.actorId,_that.action,_that.targetId,_that.timestamp,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String actorId,  String action,  String targetId,  DateTime timestamp,  Map<String, dynamic>? metadata)?  $default,) {final _that = this;
switch (_that) {
case _AuditLog() when $default != null:
return $default(_that.id,_that.actorId,_that.action,_that.targetId,_that.timestamp,_that.metadata);case _:
  return null;
...
class _AuditLog implements AuditLog {
  const _AuditLog({required this.id, required this.actorId, required this.action, required this.targetId, required this.timestamp, final  Map<String, dynamic>? metadata}): _metadata = metadata;
  factory _AuditLog.fromJson(Map<String, dynamic> json) => _$AuditLogFromJson(json);

@override final  String id;
@override final  String actorId;
@override final  String action;
// e.g., 'TASK_DELETED', 'LEAD_CREATED'
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,actorId,action,targetId,timestamp,const DeepCollectionEquality().hash(_metadata));
...
/// Create a copy of AuditLog
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? actorId = null,Object? action = null,Object? targetId = null,Object? timestamp = null,Object? metadata = freezed,}) {
