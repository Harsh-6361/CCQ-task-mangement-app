...
String _$authRepositoryHash() => r'5e5627285f53fa7e875cf575c163e91d395d5094';
...
String _$userIdHash() => r'e43a1bf88514847d3e1e29e77809cef64096c7d8';
...
final class ActiveUserContextProvider
    extends $NotifierProvider<ActiveUserContext, String?> {
  ActiveUserContextProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'activeUserContextProvider',
        isAutoDispose: true,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$activeUserContextHash();

  @$internal
  @override
  ActiveUserContext create() => ActiveUserContext();
...
String _$activeUserContextHash() => r'e7b74e224ba8164a17ceb3a671f2e75a34074d4e';

abstract class _$ActiveUserContext extends $Notifier<String?> {
  String? build();
  @$mustCallSuper
  @override
  void runBuild() {
